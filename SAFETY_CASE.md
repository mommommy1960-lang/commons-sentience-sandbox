...
This repository addresses simulated agents, memory, trust, reflection, identity continuity, governance, and adversarial evaluation. Unless a release states otherwise with reproducible evidence, its components are research, prototype, documentation, or simulation artifacts and are not approved for safety-critical production use.
