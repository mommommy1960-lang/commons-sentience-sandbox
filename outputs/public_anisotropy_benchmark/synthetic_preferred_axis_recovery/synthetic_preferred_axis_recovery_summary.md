# Public Anisotropy Study: synthetic_preferred_axis_recovery

**Catalog:** synthetic_preferred_axis  
**Generated:** 2026-04-21T06:42:51.239375Z  
**Events:** 300  
...
|--------|----------|--------------------|
| Hemisphere imbalance | 0.3533 | 1.0 |
| Preferred-axis score (48 axes) | 0.3399 | 1.0 |
| Energy–time Pearson r | -0.051 | 0.62 |
| Clustering score | 0.9955 | 0.44 |

## Null model

- Mode: isotropic
- Repeats: 50
- Null axis score mean: 0.04

## Catalog coverage

- Events: 300
- Instruments: EXAMPLE-A, EXAMPLE-B, EXAMPLE-C
- Time span: MJD 58005.54 – 58998.90 (993.4 days)
