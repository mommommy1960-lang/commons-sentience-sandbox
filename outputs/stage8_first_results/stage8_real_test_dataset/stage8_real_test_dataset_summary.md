# Public Anisotropy Study: stage8_real_test_dataset

**Catalog:** real_test_dataset  
**Generated:** 2026-04-21T08:02:19.498425Z  
**Events:** 104  
**Signal tier:** `no_anomaly_detected`  
**Max percentile:** 0.5000
...
|--------|----------|--------------------|
| Hemisphere imbalance | 0.0 | 0.0 |
| Preferred-axis score (0 axes) | 0.0 | 0.0 |
| Energy–time Pearson r | None | 0.5 |
| Clustering score | 1.0 | 0.0 |

## Null model

- Mode: isotropic
- Repeats: 100
- Null axis score mean: 0.09
