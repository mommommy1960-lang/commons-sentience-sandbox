...
**Run name:** `stage12_icecube_confirmatory_rerun`  
**Generated:** 2026-04-21T20:45:15.955942Z  
**Catalog:** `icecube_hese_events` (`/workspaces/commons-sentience-sandbox/data/real/icecube_hese_events.csv`)  
**Stage:** Stage 8 — First Real-Catalog Results Package  
**Run mode:** `preregistered_confirmatory_with_mismatch`  

---

## 1. What Was Run

The Stage 7 public-data anisotropy study was run on the catalog `icecube_hese_events` (37 events after normalisation). The pipeline tested four primary metrics against an isotropic null ensemble of 500 synthetic draws:
...
Plan match status: **MISMATCH**
Mismatches:
- plan_not_locked_for_confirmatory_run
...
|--------|----------------------|------|
| hemisphere_imbalance | 0.9720 | notable |
| preferred_axis_score | 0.6560 | null |
