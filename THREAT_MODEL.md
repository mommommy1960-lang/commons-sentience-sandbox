...
This repository covers simulated agents, memory, trust, reflection, identity continuity, governance, and adversarial evaluation. This document establishes a baseline and must be revised as architecture and evidence change.
